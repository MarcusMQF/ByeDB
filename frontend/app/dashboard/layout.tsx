    ...
    <SidebarProvider>
      ...
      <SidebarInset className="bg-sidebar group/sidebar-inset">
        ...
        <SettingsPanelProvider>
          <DatasetProvider>
            <div className="flex h-[calc(100svh-4rem)] overflow-hidden bg-[hsl(240_5%_92.16%)] md:rounded-t-3xl md:rounded-tl-3xl md:group-peer-data-[state=collapsed]/sidebar-inset:rounded-tl-none transition-all ease-in-out duration-300">
              {children}
              <SettingsPanel />
            </div>
          </DatasetProvider>
